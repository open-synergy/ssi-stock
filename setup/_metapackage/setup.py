...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-ssi_stock_dropship_operation',
        'odoo14-addon-ssi_stock_equipment_operation',
        'odoo14-addon-ssi_stock_fixed_asset',
        'odoo14-addon-ssi_stock_location_m2o_configurator_mixin',
        'odoo14-addon-ssi_stock_operating_unit',
        ...
        'odoo14-addon-ssi_stock_revaluation_operating_unit',
        'odoo14-addon-ssi_stock_route_m2o_configurator_mixin',
        'odoo14-addon-ssi_stock_valuation_layer_recomputation',
        'odoo14-addon-ssi_stock_valuation_layer_recomputation_operating_unit',
